...
export const ADMIN_HUB_TOOLBAR_CONTROL_CLASS = `${ADMIN_HUB_TOOLBAR_CONTROL_HEIGHT} rounded-[8px] border border-[#C8C8C8] bg-white text-[14px] focus:border-[#0097B2] focus:outline-none focus:ring-1 focus:ring-[#0097B2]`;
