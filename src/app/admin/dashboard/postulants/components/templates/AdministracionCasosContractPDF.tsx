 ...
 * Currently referenced only by deprecated PDFPreviewSSG; SignContractModal uses StatementOfWork variants.
 */
import {
  Document,
  Page,
...
// Reutilizando los mismos estilos base
...
interface AdministracionCasosContractPDFProps {
  data: ContractData;
}

const AdministracionCasosContractPDF: React.FC<
  AdministracionCasosContractPDFProps
> = ({ data }) => {
...
export default AdministracionCasosContractPDF;
