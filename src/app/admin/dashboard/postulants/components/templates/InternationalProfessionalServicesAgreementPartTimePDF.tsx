...
/**
 * Variante part-time del International Professional Services Agreement.
 *
 * Usa los mismos campos del formulario que la versión full-time. Las
 * diferencias respecto de aquella son las del documento legal:
 * - Título y preámbulo aclaran la modalidad part-time.
 * - Cláusula Uno: actividades "part-time".
 * - Cláusula Dos: "Part-Time Monthly Fee", proporcional a la jornada acordada.
 * - Cláusula Tres: sin PTO, sin festivos y sin incentivos ni bonos; el único
 *   incremento es el ajuste anual del 5%.
 */
type Data = {
...
const InternationalProfessionalServicesAgreementPartTimePDF: React.FC<{
  data: Data;
}> = ({ data }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>
          INTERNATIONAL PROFESSIONAL SERVICES AGREEMENT – PART-TIME
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          independent professional services on a part-time basis; and WHEREAS,
          THE CONTRACTOR represents that he/she has the experience, capacity,
          and qualifications necessary to provide such services; NOW, THEREFORE,
        ...
        <Text style={styles.paragraph}>
          ...
          employee, shall perform part-time activities that may include, without
          limitation:{" "}
        ...
        <Text style={styles.paragraph}>
          ...
          for the part-time services rendered under this Agreement shall be USD
          $ {fmtMoney(data.ofertaSalarial)} (the{" "}
          <Text style={styles.bold}>&quot;Part-Time Monthly Fee&quot;</Text>),
          payable on a monthly basis during the term of this Agreement,
          calculated in proportion to the part-time schedule agreed between the
          Parties.
        </Text>
        ...
        <Text style={styles.listItem}>
          • Part-Time Engagement. THE CONTRACTOR renders services under this
          Agreement on a part-time basis. Accordingly, THE CONTRACTOR does not
          accrue paid time off (PTO), is not entitled to payment for local
          public holidays (&quot;festivos&quot;), and is not eligible to receive
          semiannual or annual incentives or bonuses of any kind.
        </Text>
        <Text style={styles.listItem}>
          • Annual Fee Adjustment. The agreed professional fees shall
          automatically increase by five percent (5%) annually. This annual
          adjustment is the only increase to which THE CONTRACTOR is entitled
          under this Agreement. Such increase shall not constitute salary,
          wages, or compensation of an employment nature, nor shall it generate
          social benefits of any kind, given by the civil and commercial nature
          of this Agreement.
        </Text>
        <Text style={styles.listItem}>
          • Civil and Commercial Nature. The annual fee adjustment provided
          herein does not constitute salary or employment compensation and does
          not create an employment relationship. THE CONTRACTOR shall maintain
          full technical, administrative, and professional autonomy in the
...
export default InternationalProfessionalServicesAgreementPartTimePDF;
