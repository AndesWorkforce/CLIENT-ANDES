...
interface CustomContractData {
  ...
  descripcionServicios: string; // Este campo será personalizable
...
interface CustomContractPDFProps {
  data: CustomContractData;
}

const CustomContractPDF: React.FC<CustomContractPDFProps> = ({ data }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Cláusula Primera - CON DESCRIPCIÓN PERSONALIZABLE */}
        ...
        <Text style={styles.paragraph}>
          ...
          {data.descripcionServicios ||
            "servicios profesionales según se acuerden entre las partes"}
          .
        </Text>
      ...
      {/* Segunda página */}
      <Page size="A4" style={styles.page}>
        {/* Continúa con todas las demás cláusulas igual que el template original */}
        <Text style={styles.clauseTitle}>
...
export default CustomContractPDF;
