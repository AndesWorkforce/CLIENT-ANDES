    ...
    <section className="relative w-full h-[600px]">
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-6">
        <div className="text-center text-white max-w-4xl drop-shadow-[0px_4px_2px_#0c505c]">
          <h1 className="text-5xl md:text-6xl lg:text-[64px] font-bold leading-[1.3]">
            We are Andes Workforce
          </h1>
          <p className="mt-4 text-xl md:text-2xl lg:text-[28px] font-semibold leading-[1.3] max-w-3xl mx-auto">
