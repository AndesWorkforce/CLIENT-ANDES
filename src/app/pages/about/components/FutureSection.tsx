export default function FutureSection() {
  return (
    <section className="w-full bg-white py-8 sm:py-24">
      <div className="max-w-[1440px] mx-auto px-[18px] sm:px-10 md:px-20 flex flex-col-reverse lg:flex-row gap-[33px] lg:gap-14 items-center">
        {/* Image — left on desktop, below text on mobile */}
        <div className="relative w-full aspect-[16/9] lg:w-[611px] lg:h-[456px] lg:aspect-auto shrink-0 overflow-hidden rounded-[15px]">
          <img
