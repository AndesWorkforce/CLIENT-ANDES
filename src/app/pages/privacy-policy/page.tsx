export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-white py-10 pt-4">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl text-center md:text-4xl font-bold text-[#08252A] mb-2">
          Privacy Policy
        </h1>
        <p className="text-[#08252A] mb-8 text-center">
          Last updated on August 24, 2024
        </p>

        <div className="prose max-w-none text-[#08252A]">
          <p>
          ...
          <p>
            Andes Workforce LLC values its users&apos; privacy. This Privacy
            ...
            designed and created to ensure those affiliated with Andes Workforce
            LLC of our commitment and realization of our obligation not only to
          ...
          <p>
            ...
            any point in time Andes Workforce LLC decides to make use of any
          ...
          <p className="mb-8">
            This Policy applies to Andes Workforce LLC, and it governs any and
            all data collection and usage by us. Through the use of
            https://andes-workforce.com/, you are therefore consenting to the
            data collection procedures expressed in this Policy.
          </p>

          <p className="mb-8">
            Please note that this Policy does not govern the collection and use
            of information by companies that Andes Workforce LLC does not
          ...
          <p className="mb-8">
            In addition, Andes Workforce LLC may have the occasion to collect
          ...
          <p className="mb-4">
            Andes Workforce LLC does not now, nor will it in the future, sell,
            rent or lease any of its customer lists and/or names to any third
            parties.
          </p>

          <p className="mb-4">
            Andes Workforce LLC may collect and may make use of personal
            ...
            may be available to you from https:// andes-workforce.com/
          </p>

          <p className="mb-8">
            Andes Workforce LLC may also be in contact with you with regards to
          ...
          <p className="mb-4">
            Andes Workforce LLC may not use or disclose the information provided
          ...
          <ul className="list-disc pl-6 mb-8">
            ...
            <li className="mb-2">
              ...
              and property of Andes Workforce LLC.
            </li>
          </ul>
          ...
          <p className="mb-8">
            Andes Workforce LLC greatly respects your privacy. We do maintain
            ...
            and/or changes in Andes Workforce LLC products and services). In
          ...
          <p className="mb-8">
            Andes Workforce LLC&apos;s website is not directed to, and does not
          ...
          <p className="mb-8">
            ...
            that you wish to unsubscribe to info@andes-workforce.com. If you
            wish to unsubscribe or opt-out from any third-party websites, you
            must go to that specific website to unsubscribe or opt-out. Andes
            Workforce LLC will continue to adhere to this Policy with respect to
          ...
          <p className="mb-8">
            Andes Workforce LLC&apos;s operations are located primarily in the
          ...
          <p className="mb-4">
            Andes Workforce LLC takes precautions to protect your information.
          ...
          <p className="mb-4">
            ...
            disclosure or modification of the user&apos;s personal information
            under our control.
          </p>
          ...
          <div className="mt-10 border-t pt-6 border-gray-200">
            ...
            <p className="mb-2">
              <strong>Telephone Number:</strong> 7572373612
            </p>
            <p className="mb-6">
